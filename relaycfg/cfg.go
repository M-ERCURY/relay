...
type C struct {
	// Address is the mercury:// listening address.
	...
	// Contracts is the map of service contracts used by this mercury-relay.
...
// Validate validates the config. It can change between mercury-relay releases.
