...
func serverun(fm fsdir.T) {
	...
	// finalizer
	var final func()
	final, err = relaylib.EnrollRelay(&c, cl, upgrade.NewConfig(fm, "mercury-relay", false))
